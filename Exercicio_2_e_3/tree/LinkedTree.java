...
public class LinkedTree<E> implements Tree<E> {
	...
	// Se v ï¿½ um bom nodo da ï¿½rvore, cast para TreePosition, caso contrï¿½rio,
	// lanï¿½a
	// exceï¿½ï¿½o
	...
	// Implantanção dos métodos solicitados Ex03
	...
	public String toStringpostorder(LinkedTree<E> T, Position<E> v) {
		/**
		* Percorre a árvore até encontrar o nodo que não tem filhos
	...
	public void postorder(LinkedTree<E> T, Position<E> v) {
		/**
		* percorre a arvore e imprimi até encontrar os nodos que não tem filho e os imprime, 
	...
	// DiskSpace
	// ------------Problema na Criação da Classe DiscNode!
